 ...
 * @created date 20 June 2019, 21:28 WIB
 * @link https://bitbucket.org/ommu/ppid
 *
 * This is the model class for table "ommu_article_ppid_setting".
 *
 * The followings are the available columns in table "ommu_article_ppid_setting":
 * @property integer $id
...
class PpidSetting extends \app\components\ActiveRecord
{
	...
	{
		return 'ommu_article_ppid_setting';
	}
	...
	{
		return [
			[['license', 'permission', 'meta_description', 'meta_keyword', 'category_id'], 'required'],
			[['permission', 'category_id', 'modified_id'], 'integer'],
	...
	public function init()
	{
		...
		$this->templateColumns['category_id'] = [
