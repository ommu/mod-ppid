...
use ommu\ppid\models\PpidPic as PpidPicModel;

class PpidPic extends PpidPicModel
{
	/**
	 * {@inheritdoc}
	 */
	public function rules()
	{
		return [
			...
			[['pic_name', 'pic_desc', 'creation_date', 'modified_date', 'updated_date', 'creationDisplayname', 'modifiedDisplayname'], 'safe'],
		];
	}
